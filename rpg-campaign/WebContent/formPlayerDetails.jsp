				...
				<table>
					...
					<tr>
						...
						<td width="50%"><input type="text"
							value="${ user.character.name }" disabled></td>
					</tr>
					<tr>
						<td width="20%"></td>
						<td width="30%">Pontos:</td>
						<td width="50%"><input type="text"
							value="${ user.character.points }" disabled></td>
					</tr>
					<tr>
						<td width="20%"></td>
						<td width="30%">Força:</td>
						<td width="50%"><input type="text"
							value="${ user.character.strength }" disabled></td>
					</tr>
					<tr>
						<td width="20%"></td>
						<td width="30%">Habilidade:</td>
						<td width="50%"><input type="text"
							value="${ user.character.dexterity }" disabled></td>
					</tr>
					<tr>
						<td width="20%"></td>
						<td width="30%">Resistência:</td>
						<td width="50%"><input type="text"
							value="${ user.character.endurance }" disabled></td>
					</tr>
					<tr>
						<td width="20%"></td>
						<td width="30%">Armadura:</td>
						<td width="50%"><input type="text"
							value="${ user.character.armor }" disabled></td>
					</tr>
					<tr>
						<td width="20%"></td>
						<td width="30%">Poder de Fogo:</td>
						<td width="50%"><input type="text"
							value="${ user.character.firePower }" disabled></td>
					</tr>
					<tr>
						<td width="20%"></td>
						<td width="30%">Level:</td>
						<td width="50%"><input type="text"
							value="${ user.character.level }" disabled></td>
					</tr>
					<tr>
						<td width="20%"></td>
						<td width="30%">Pontos de Vida:</td>
						<td width="50%"><input type="text"
							value="${ user.character.hitPoints }" disabled></td>
					</tr>
					<tr>
						<td width="20%"></td>
						<td width="30%">Pontos de Magia:</td>
						<td width="50%"><input type="text"
							value="${ user.character.magicPoints }" disabled></td>
					</tr>
					<tr>
						<td width="20%"></td>
						<td width="30%">Vantagens:</td>
						<td width="50%"><input type="text"
							value="${ user.character.advantages }" disabled></td>
					</tr>
					<tr>
						<td width="20%"></td>
						<td width="30%">Desvantagens:</td>
						<td width="50%"><input type="text"
							value="${ user.character.disadvantages }" disabled></td>
					</tr>
					<tr>
						<td width="20%"></td>
						<td width="30%">Tipos de Dano:</td>
						<td width="50%"><input type="text"
							value="${ user.character.damageTypes }" disabled></td>
					</tr>
					<tr>
						<td width="20%"></td>
						<td width="30%">Magias Conhecidas:</td>
						<td width="50%"><input type="text"
							value="${ user.character.knownSpells }" disabled></td>
					</tr>
					<tr>
						<td width="20%"></td>
						<td width="30%">Dinheiro e Itens:</td>
						<td width="50%"><input type="text"
							value="${ user.character.moneyAndItems }" disabled></td>
					</tr>
				</table>
			</form>
			<%
				System.out.println("[Log] : Página formPlayerDetails acessada!");
			%>
			<!-- End About Section -->
		</div>
