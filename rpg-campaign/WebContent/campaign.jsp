...
<body class="w3-black">
	...
	<div class="w3-padding-large" id="main">
		...
		<div class="w3-content w3-justify w3-text-grey w3-padding-64"
			...
			<ul>
				<li><a href="/rpg-campaign/formNewCampaign.jsp">Criar Campanha</a></li>
				<li><a href="/rpg-campaign/list-campaign">Gerenciar Campanhas</a></li>
			</ul>
			<%
				System.out.println("[Log] : Página campaign acessada!");
			%>
			<!-- End About Section -->
		</div>
