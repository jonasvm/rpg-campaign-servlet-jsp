...
<body class="w3-black">
	...
	<div class="w3-top w3-hide-large w3-hide-medium" id="myNavbar">
		<div
			...
			<a href="/rpg-campaign" class="w3-bar-item w3-button"
				style="width: 25% !important">HOME</a> <a href="/rpg-campaign/user.jsp"
				class="w3-bar-item w3-button" style="width: 25% !important">USUÁRIOS</a>
			<a href="/rpg-campaign/campaign.jsp"" class="w3-bar-item w3-button"
	...
	<div class="w3-padding-large" id="main">
		...
		<div class="w3-content w3-justify w3-text-grey w3-padding-64"
			...
			<ul>
				<li><a href="/rpg-campaign/formNewDM.jsp">Criar Dungeon Master (mestre)</a></li>
				<li><a href="/rpg-campaign/formNewPlayer.jsp">Criar Personagem</a></li>
				<li><a href="/rpg-campaign/list-user">Gerenciar Usuários</a></li>
			</ul>
			<% System.out.println("[Log] : Página user acessada!"); %>
			<!-- End About Section -->
		</div>
