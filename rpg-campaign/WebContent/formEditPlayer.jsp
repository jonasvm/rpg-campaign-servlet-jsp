...
<c:url value="/edit-player" var="linkEditPlayer" />
...
<body class="w3-black">
	...
	<div class="w3-padding-large" id="main">
		...
		<div class="w3-content w3-justify w3-text-grey w3-padding-64"
			...
			<form action="${linkEditPlayer}" method="post">
				<table>
					<tr>
						<td width="20%"></td>
						<td width="30%"></td>
						<td width="50%"><input type="text" value="${ user.id }" style="display:none;" name="id"></td>
					</tr>
					<tr>
						<td width="20%"></td>
						<td width="30%">Nome:</td>
						<td width="50%"><input type="text" value="${ user.username }" name="name"></td>
					</tr>
					<tr>
						<td width="20%"></td>
						<td width="30%">Email:</td>
						<td width="50%"><input type="text" value="${ user.email }"  name="email"></td>
					</tr>
					<tr>
						<td width="20%"></td>
					...
					<tr>
						...
						<td width="50%"><input type="text"
							value="${ user.character.name }" name="characterName"></td>
					</tr>
					<tr>
						<td width="20%"></td>
						<td width="30%">Pontos:</td>
						<td width="50%"><input type="text"
							value="${ user.character.points }" name="points"></td>
					</tr>
					<tr>
						<td width="20%"></td>
						<td width="30%">Força:</td>
						<td width="50%"><input type="text"
							value="${ user.character.strength }" name="strength"></td>
					</tr>
					<tr>
						<td width="20%"></td>
						<td width="30%">Habilidade:</td>
						<td width="50%"><input type="text"
							value="${ user.character.dexterity }" name="dexterity"></td>
					</tr>
					<tr>
						<td width="20%"></td>
						<td width="30%">Resistência:</td>
						<td width="50%"><input type="text"
							value="${ user.character.endurance }" name="endurance"></td>
					</tr>
					<tr>
						<td width="20%"></td>
						<td width="30%">Armadura:</td>
						<td width="50%"><input type="text"
							value="${ user.character.armor }" name="armor"></td>
					</tr>
					<tr>
						<td width="20%"></td>
						<td width="30%">Poder de Fogo:</td>
						<td width="50%"><input type="text"
							value="${ user.character.firePower }" name="firepower"></td>
					</tr>
					<tr>
						<td width="20%"></td>
						<td width="30%">Level:</td>
						<td width="50%"><input type="text"
							value="${ user.character.level }" name="level"></td>
					</tr>
					<tr>
						<td width="20%"></td>
						<td width="30%">Pontos de Vida:</td>
						<td width="50%"><input type="text"
							value="${ user.character.hitPoints }" name="hitPoints"></td>
					</tr>
					<tr>
						<td width="20%"></td>
						<td width="30%">Pontos de Magia:</td>
						<td width="50%"><input type="text"
							value="${ user.character.magicPoints }" name="magicPoints"></td>
					</tr>
					<tr>
						<td width="20%"></td>
						<td width="30%">Vantagens:</td>
						<td width="50%"><input type="text"
							value="${ user.character.advantages }" name="advantages"></td>
					</tr>
					<tr>
						<td width="20%"></td>
						<td width="30%">Desvantagens:</td>
						<td width="50%"><input type="text"
							value="${ user.character.disadvantages }" name="disadvantages"></td>
					</tr>
					<tr>
						<td width="20%"></td>
						<td width="30%">Tipos de Dano:</td>
						<td width="50%"><input type="text"
							value="${ user.character.damageTypes }" name="damageTypes"></td>
					</tr>
					<tr>
						<td width="20%"></td>
						<td width="30%">Magias Conhecidas:</td>
						<td width="50%"><input type="text"
							value="${ user.character.knownSpells }" name="knownSpells"></td>
					</tr>
					<tr>
						<td width="20%"></td>
						<td width="30%">Dinheiro e Itens:</td>
						<td width="50%"><input type="text"
							value="${ user.character.moneyAndItems }" name="moneyAndItems"></td>
					</tr>
					<tr>
						<td width="20%"></td>
						<td width="30%"></td>
			...
			<%
				System.out.println("[Log] : Página formEditPlayer acessada!");
			%>
			<!-- End About Section -->
		</div>
