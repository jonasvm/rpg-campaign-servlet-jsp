...
<%@ page import="java.util.List, br.com.rpg.campaign.user.model.DungeonMaster"%>
...
<body class="w3-black">
	...
	<div class="w3-padding-large" id="main">
		...
		<div class="w3-content w3-justify w3-text-grey w3-padding-64"
			...
			Nome - ${ campaignName }<br> 
			Dungeon Master - ${ dm.username }<br> 
			Data de Criação -
			<fmt:formatDate value="${ creationDate }" pattern="dd/MM/yyyy" />
			<br>
			<%
				System.out.println("[Log] : Página campaignDetails acessada!");
			%>
			<!-- End About Section -->
		</div>
