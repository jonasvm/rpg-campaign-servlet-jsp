...
<c:url value="/edit-campaign" var="linkEditCampaign" />
...
<body class="w3-black">
	...
	<div class="w3-padding-large" id="main">
		...
		<div class="w3-content w3-justify w3-text-grey w3-padding-64"
			...
			<form action="${linkEditCampaign}" method="post">
				<table>
					<tr>
						<td width="20%"></td>
						<td width="30%"></td>
						<td width="50%"><input type="text" name="id" style="display:none;"
							value="${ campaign.id }" ></td>
					</tr>
					<tr>
						<td width="20%"></td>
						<td width="30%">Nome:</td>
					...
					<tr>
						...
						<td width="50%"><input type="text" name="dungeonMaster"
							value="${ campaign.dungeonMaster.username }"></td>
					</tr>
					<tr>
						<td width="20%"></td>
			...
			<%
				System.out.println("[Log] : Página formEditCampaign acessada!");
			%>
			<!-- End About Section -->
		</div>
