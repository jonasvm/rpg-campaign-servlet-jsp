...
<c:url value="/edit-dm" var="linkEditDM" />
...
<body class="w3-black">
	...
	<div class="w3-padding-large" id="main">
		...
		<div class="w3-content w3-justify w3-text-grey w3-padding-64"
			id="about">
			<h2 class="w3-text-light-grey">Editar Dungeon Master</h2>
			<hr style="width: 200px" class="w3-opacity">
			<form action="${linkEditDM}" method="post">
				<table>
					<tr>
						<td width="20%"></td>
						<td width="30%"></td>
						<td width="50%"><input type="text" value="${ dm.id }" name="id" style="display:none;"></td>
					</tr>
					<tr>
						<td width="20%"></td>
						<td width="30%">Nome:</td>
						<td width="50%"><input type="text" value="${ dm.username }" name="name"></td>
					</tr>
					<tr>
						<td width="20%"></td>
						<td width="30%">Email:</td>
						<td width="50%"><input type="text" value="${ dm.email }" name="email"></td>
					</tr>
					<tr>
						<td width="20%"></td>
						<td width="30%">Senha:</td>
						<td width="50%"><input type="password"
							value="${ dm.password }" name="password"></td>
					</tr>
					<tr>
						<td width="20%"></td>
						<td width="30%"></td>
			...
			<%
				System.out.println("[Log] : Página formEditDM acessada!");
			%>
			<!-- End About Section -->
		</div>
