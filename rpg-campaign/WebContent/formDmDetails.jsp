...
<c:url value="/new-dm" var="linkNewDM" />
...
<body class="w3-black">
	...
	<nav class="w3-sidebar w3-bar-block w3-small w3-hide-small w3-center">
		...
		<img src="images/rpg-mesa.jpg" style="width: 100%"> <a href="/rpg-campaign"
	...
	<div class="w3-top w3-hide-large w3-hide-medium" id="myNavbar">
		<div
			...
			<a href="/rpg-campaign" class="w3-bar-item w3-button"
				...
				style="width: 25% !important">USUÁRIOS</a> <a href="/rpg-campaign/campaign.jsp"
	...
	<div class="w3-padding-large" id="main">
		...
		<div class="w3-content w3-justify w3-text-grey w3-padding-64"
			id="about">
			<h2 class="w3-text-light-grey">Detalhes do Dungeon Master</h2>
			<hr style="width: 200px" class="w3-opacity">
			<form action="${linkNewDM}" method="post">
				<table>
					<tr>
						<td width="20%"></td>
						<td width="30%">Nome:</td>
						<td width="50%"><input type="text" value="${ dm.username }" disabled></td>
					</tr>
					<tr>
						<td width="20%"></td>
						<td width="30%">Email:</td>
						<td width="50%"><input type="text" value="${ dm.email }" disabled></td>
					</tr>
					<tr>
						<td width="20%"></td>
						<td width="30%">Senha:</td>
						<td width="50%"><input type="password" value="${ dm.password }" disabled></td>
					</tr>
				</table>
			</form>
			<%
				System.out.println("[Log] : Página formDmDetails acessada!");
			%>
			<!-- End About Section -->
		</div>
